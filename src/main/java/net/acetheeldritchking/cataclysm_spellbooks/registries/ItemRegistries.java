...
public class ItemRegistries {
     ...
     */
    // Ignis Wizard Armor
    public static final DeferredHolder<Item, Item> IGNITIUM_WIZARD_HELMET = ITEMS.register("ignis_helmet", () -> new IgnisWizardArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredHolder<Item, Item> IGNITIUM_WIZARD_CHESTPLATE = ITEMS.register("ignis_chestplate", () -> new IgnisWizardArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> IGNITIUM_WIZARD_CHESTPLATE_ELYTRA = ITEMS.register("ignis_chestplate_elytra", () -> new IgnisWizardElytraArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> IGNITIUM_WIZARD_LEGGINGS = ITEMS.register("ignis_leggings", () -> new IgnisWizardArmorItem(ArmorItem.Type.LEGGINGS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.LEGGINGS.getDurability(40))));
    public static final DeferredHolder<Item, Item> IGNITIUM_WIZARD_BOOTS = ITEMS.register("ignis_boots", () -> new IgnisWizardArmorItem(ArmorItem.Type.BOOTS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.BOOTS.getDurability(40))));

    // Abyssal Warlock Armor
    public static final DeferredHolder<Item, Item> ABYSSAL_WARLOCK_HELMET = ITEMS.register("abyssal_warlock_helmet", () -> new AbyssalWarlockArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredHolder<Item, Item> ABYSSAL_WARLOCK_MASK = ITEMS.register("abyssal_warlock_mask", () -> new AbyssalWarlockMaskItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> ABYSSAL_WARLOCK_CHESTPLATE = ITEMS.register("abyssal_warlock_chestplate", () -> new AbyssalWarlockArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> ABYSSAL_WARLOCK_LEGGINGS = ITEMS.register("abyssal_warlock_leggings", () -> new AbyssalWarlockArmorItem(ArmorItem.Type.LEGGINGS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.LEGGINGS.getDurability(40))));
    public static final DeferredHolder<Item, Item> ABYSSAL_WARLOCK_BOOTS = ITEMS.register("abyssal_warlock_boots", () -> new AbyssalWarlockArmorItem(ArmorItem.Type.BOOTS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.BOOTS.getDurability(40))));

    // Cursium Mage Set
    public static final DeferredHolder<Item, Item> CURSIUM_MAGE_HELMET = ITEMS.register("cursium_mage_circlet", () -> new CursiumMageArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredHolder<Item, Item> CURSIUM_MAGE_CHESTPLATE = ITEMS.register("cursium_mage_chestplate", () -> new CursiumMageArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> CURSIUM_MAGE_CHESTPLATE_ELYTRA = ITEMS.register("cursium_mage_elytra", () -> new CursiumMageElytraArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> CURSIUM_MAGE_LEGGINGS = ITEMS.register("cursium_mage_skirt", () -> new CursiumMageArmorItem(ArmorItem.Type.LEGGINGS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.LEGGINGS.getDurability(40))));
    public static final DeferredHolder<Item, Item> CURSIUM_MAGE_BOOTS = ITEMS.register("cursium_mage_boots", () -> new CursiumMageArmorItem(ArmorItem.Type.BOOTS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.BOOTS.getDurability(40))));

    // Pharaoh Mage Set
    public static final DeferredHolder<Item, Item> PHARAOH_MAGE_HELMET = ITEMS.register("pharaoh_helmet",
            () -> new PharaohMageArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredHolder<Item, Item> PHARAOH_MAGE_CHESTPLATE = ITEMS.register("pharaoh_chestplate",
            () -> new PharaohMageArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> PHARAOH_MAGE_LEGGINGS = ITEMS.register("pharaoh_leggings",
            () -> new PharaohMageArmorItem(ArmorItem.Type.LEGGINGS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.LEGGINGS.getDurability(40))));
    public static final DeferredHolder<Item, Item> PHARAOH_MAGE_BOOTS = ITEMS.register("pharaoh_greaves",
            () -> new PharaohMageArmorItem(ArmorItem.Type.BOOTS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.BOOTS.getDurability(40))));

    // Bloom Stone Mage Set
    public static final DeferredHolder<Item, Item> BLOOM_STONE_HAT = ITEMS.register("bloom_stone_hat",
            () -> new BloomStoneMageArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredHolder<Item, Item> BLOOM_STONE_CHESTPLATE = ITEMS.register("bloom_stone_chestplate",
            () -> new BloomStoneMageArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> BLOOM_STONE_SKIRT = ITEMS.register("bloom_stone_skirt",
            () -> new BloomStoneMageArmorItem(ArmorItem.Type.LEGGINGS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.LEGGINGS.getDurability(40))));
    public static final DeferredHolder<Item, Item> BLOOM_STONE_GREAVES = ITEMS.register("bloom_stone_greaves",
            () -> new BloomStoneMageArmorItem(ArmorItem.Type.BOOTS, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.BOOTS.getDurability(40))));
    ...
    public static final DeferredHolder<Item, Item> MONSTROUS_WIZARD_HAT = ITEMS.register("monstrous_wizard_hat",
            () -> new MonstrousWizardHatArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    ...
    public static final DeferredHolder<Item, Item> EXCELSIUS_SPEED_HELMET = ITEMS.register("excelsius_speed_visors",
            () -> new ExcelsiusCooldownArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredHolder<Item, Item> EXCELSIUS_SPEED_CHESTPLATE = ITEMS.register("excelsius_speed_chestplate",
            () -> new ExcelsiusCooldownArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> EXCELSIUS_POWER_HELMET = ITEMS.register("excelsius_power_visors",
            () -> new ExcelsiusPowerArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredHolder<Item, Item> EXCELSIUS_POWER_CHESTPLATE = ITEMS.register("excelsius_power_chestplate",
            () -> new ExcelsiusPowerArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredHolder<Item, Item> EXCELSIUS_RESIST_HELMET = ITEMS.register("excelsius_resist_visors",
            () -> new ExcelsiusResistArmorItem(ArmorItem.Type.HELMET, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredHolder<Item, Item> EXCELSIUS_RESIST_CHESTPLATE = ITEMS.register("excelsius_resist_chestplate",
            () -> new ExcelsiusResistArmorItem(ArmorItem.Type.CHESTPLATE, ItemPropertiesHelper.equipment(1).component(DataComponents.UNBREAKABLE, new Unbreakable(false)).fireResistant().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
