...
public class CursedRushSpell extends AbstractMaledictusSpell {
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        {
            entity.addEffect(new MobEffectInstance(CSPotionEffectRegistry.CURSED_FRENZY, 20, (int) getBonusDamage(spellLevel, entity), false, false, false));
        } else
        {
            entity.addEffect(new MobEffectInstance(CSPotionEffectRegistry.CURSED_FRENZY, 20, (int) getDamage(spellLevel, entity), false, false, false));
        }
